...
let AMP_MIN=0.02;
let AMP_MAX=0.07;
let limiteAgudoGrave=0.5; // en esta variable se configura a partir de cuando es grave o agudo.

// fin de configuración de frecuencia y amplitud
...
createCanvas(720, 1280);
  ...
  // rectangulo Rojo 
    { x:random(100,500) , y:530 , w: 30,h: 611,ang : 35 + random(1,5)  ,color:  '#D14A1C', img: rojo },
    { x:639 , y:  random(100, 1000) , w: 60,h: 17,ang : 80 + random(1,5)  ,color:  '#D14A1C', img: rojo },
    { x:519 , y: random(100, 1000)  , w: 68,h: 160,ang : 13 + random(0,5),color:  '#D14A1C', img: rojo },
    { x:random(100, 1000) , y: 1214 , w: 27,h: 138,ang : 29 + random(0,5),color:  '#D14A1C', img: rojo },
  //rectangulo Amarillo 
    { x:107 , y:154 , w: 62,h: 97,ang : 29 + random(0,5) ,color:  '#F9C913', img: amarillo},
    { x:random(100, 1000) , y:88 , w: 22,h: 113,ang : 35 + random(0,5) ,color:  '#F9C913', img: amarillo}, 
    { x:620 , y:162 , w: 184,h: 40,ang : 90 + random(0,5), color:  '#F9C913', img: amarillo}, 
    { x:random(100, 1000) , y:243 , w: 17,h: 48,ang : 95 + random(0,5) ,color:  '#F9C913', img: amarillo}, 
    { x:572 , y:367 , w: 17,h: 196,ang : 95 + random(0,5) ,color:  '#F9C913', img: amarillo}, 
    { x:random(100, 1000) , y:368, w: 17,h: 196,ang : 95 + random(0,5) ,color:  '#F9C913', img: amarillo}, 
    { x:random(100, 1000) , y:823, w: 46,h: 148,ang : 95 + random(0,5),color:  '#F9C913', img: amarillo},
    { x:208 , y:random(100, 1000) , w: 50,h: 28,ang : 29 + random(0,5),color:  '#F9C913', img: amarillo}, 
    { x:random(100, 1000) , y:930, w: 126,h: 27,ang : 65 + random(0,5),color:  '#F9C913', img: amarillo}, 
    { x:658 , y:random(100, 1000) , w: 67,h: 21,ang : 65 + random(0,5),color:  '#F9C913', img: amarillo}, 
  // rectangulo Negro 
    { x:446 , y:random(100, 1000)  , w: 359,h: 62,ang : 16 + random(0,5),color:  '#000000', img: negro },   
    { x:293 , y:random(100, 1000)  , w: 22,h: 137,ang : 35  + random(0,5),color:  '#000000', img: negro },
    { x:random(100, 1000) , y:766 , w: 37,h: 261,ang : 29  + random(0,5),color:  '#000000', img: negro },
    { x:410 , y:random(100, 1000)  , w: 36,h: 360,ang : 29 + random(0,5),color:  '#000000', img: negro },
    { x:random(100, 1000) , y:874 , w: 27,h: 167,ang : 29 + random(0,5),color:  '#000000', img: negro },
    { x:532 , y:random(100, 1000)  , w: 10,h: 113,ang : 112 + random(0,5),color:  '#000000', img: negro },
    { x:random(100, 1000) , y:1100 , w: 10,h: 174,ang : 112 + random(0,5),color:  '#000000', img: negro },
    { x:174 , y:random(100, 1000)  , w: 39,h: 55,ang : 29 + random(0,5),color:  '#000000', img: negro },
  // rectangulo Azul 
    { x:random(100, 1000) , y:618 , w: 109,h:19 ,ang : 45 + random(0,5),color:  '#031351', img: azul },
    { x:280 , y:random(100, 1000)  , w: 83,h:19 ,ang : 109 + random(0,5),color:  '#031351', img: azul },
    { x:random(100, 1000) , y:1239 , w: 52,h:19 ,ang : 109 + random(0,5),color:  '#031351', img: azul },
...
if (estado=="sonidoAGraveProlongado"){
  for (let p of particles) {
    if (p.tipo !='square') {
      p.newColor(); //FALTA HACER LA FUNCION SI ES QUE SE VA A USAR.
    } 
  }
}
...
/*Solo para pruebas de estados
function mousePressed() {

  if (marca2){
 if(estado=="sinMovimiento"){estado="sonidoGrave";}else
 if(estado=="sonidoGrave"){estado="sonidoGraveProlongado";}else
 if(estado=="sonidoGraveProlongado"){estado="sonidoAgudo";}else
 if(estado=="sonidoAgudo"){estado="sonidoAgudoProlongado";}else
  if(estado=="sonidoAgudoProlongado"){estado="sinMovimiento";}
